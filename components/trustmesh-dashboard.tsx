    ...
    <article className={`agent-card agent-card--${agent.role} ${active ? "is-active" : ""}`}>
      ...
      <div className="agent-browser">
        ...
        <div className="browser-content">
          ...
          {typeof agent.price === "number" && <em>${agent.price.toLocaleString()}</em>}
    ...
    <section className="product-section" id="control-plane">
      ...
      <div className="decision-grid">
        <div className="evidence-summary">
          ...
          <div className="staged-action"><small>STAGED ACTION</small><p>{mission.recommendedAction}</p></div>
        </div>
...
export function TrustMeshDashboard() {
  ...
  const [mission, setMission] = React.useState(() => createDemoMission())
